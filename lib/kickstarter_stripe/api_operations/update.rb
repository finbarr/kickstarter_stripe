    ...
    module Update
      def save(opts={})
        ...
        if values.length > 0
          ...
          response, api_key = KickstarterStripe.request(:post, url, @api_key, values)
      ...
      def serialize_metadata
        if @unsaved_values.include?(:metadata)
          ...
          # metadata is a KickstarterStripeObject, and can be serialized normally
