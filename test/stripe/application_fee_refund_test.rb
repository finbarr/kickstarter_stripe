...
module KickstarterStripe
  class ApplicationFeeRefundTest < Test::Unit::TestCase
    should "refunds should be listable" do
      ...
      application_fee = KickstarterStripe::ApplicationFee.retrieve('test_application_fee')

      assert application_fee.refunds.first.kind_of?(KickstarterStripe::ApplicationFeeRefund)
    end
