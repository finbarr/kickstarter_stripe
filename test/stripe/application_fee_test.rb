...
module KickstarterStripe
  class ApplicationFeeTest < Test::Unit::TestCase
    should "application fees should be listable" do
      ...
      fees = KickstarterStripe::ApplicationFee.all
      assert fees.data.kind_of? Array
      fees.each do |fee|
        assert fee.kind_of?(KickstarterStripe::ApplicationFee)
      end
    end
    ...
    should "application fees should be refundable" do
      ...
      fee = KickstarterStripe::ApplicationFee.new("test_application_fee")
      fee.refund
      assert fee.refunded
    end
  end
